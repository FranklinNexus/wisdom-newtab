...
Wisdom New Tab is available as a desktop browser extension and an installable mobile web app. Both provide search, shortcuts, public developer news, and a local focus timer. This policy explains the limited data each version handles.
